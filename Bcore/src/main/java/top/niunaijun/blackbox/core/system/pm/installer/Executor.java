...
public interface Executor {
    ...
    public static class CopyExecutor implements Executor {
        @Override
    ...
    public static class CreatePackageExecutor implements Executor {
        @Override
        public int exec(BPackageSettings ps, InstallOption option, int userId) {
    ...
    public static class CreateUserExecutor implements Executor {
        @Override
        public int exec(BPackageSettings ps, InstallOption option, int userId) {
    ...
    public static class RemoveAppExecutor implements Executor {
        @Override
        public int exec(BPackageSettings ps, InstallOption option, int userId) {
            FileUtils.deleteDir(BEnvironment.getAppDir(ps.pkg.packageName));
            return 0;
    ...
    public static class RemoveUserExecutor implements Executor {
        @Override
        public int exec(BPackageSettings ps, InstallOption option, int userId) {
            String packageName = ps.pkg.packageName;
