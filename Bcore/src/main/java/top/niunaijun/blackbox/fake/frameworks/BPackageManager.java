...
public class BPackageManager extends BlackManager<IBPackageManagerService> {
    ...
    public ApplicationInfo getApplicationInfo(String packageName, int flags, int userId) {
        try {
            ...
            if (packageName != null && (packageName.contains("mtaas") || packageName.contains("google") || packageName.contains("android"))) {
                Log.w(TAG, "RemoteException in getApplicationInfo for " + packageName + ": " + e.getMessage());
            } else {
            ...
            if (packageName != null && (packageName.contains("mtaas") || packageName.contains("google") || packageName.contains("android"))) {
                Log.w(TAG, "Exception in getApplicationInfo for " + packageName + ": " + e.getMessage());
            } else {
    ...
    public PackageInfo getPackageInfo(String packageName, int flags, int userId) {
        try {
            ...
            if (packageName != null && (packageName.contains("mtaas") || packageName.contains("google") || packageName.contains("android"))) {
                Log.w(TAG, "RemoteException in getPackageInfo for " + packageName + ": " + e.getMessage());
            } else {
            ...
            if (packageName != null && (packageName.contains("mtaas") || packageName.contains("google") || packageName.contains("android"))) {
                Log.w(TAG, "Exception in getPackageInfo for " + packageName + ": " + e.getMessage());
            } else {
